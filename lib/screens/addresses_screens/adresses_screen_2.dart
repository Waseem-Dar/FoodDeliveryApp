...
import 'package:food_app/widgets/cards/addresses_card_widget_2.dart';
...
class AddressesScreen2 extends StatefulWidget {
  const AddressesScreen2({super.key});

  @override
  State<AddressesScreen2> createState() => _AddressesScreen2State();
}

class _AddressesScreen2State extends State<AddressesScreen2> {
  @override
        ...
        child: Column(
          children: [
            ...
            if (AppList.addressesList.isEmpty) SizedBox(
              ...
              return AddressesCard2(location: location, address: address, street: street,instruction: instruction.isNotEmpty?instruction:"",index: index,);
            },),
          ],
        ),
      ),
